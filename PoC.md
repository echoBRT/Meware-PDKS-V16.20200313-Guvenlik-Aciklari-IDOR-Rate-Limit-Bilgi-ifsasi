...
##  ZAFİYET 2: Rate Limit Eksikliği - Sınırsız Talep Oluşturma
### Açıklama
...
│  │ 607 (Gözde ), 350 (Uğur ), 531 (meyer admin)...            │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                      │                                      │
│                                      ▼                                      │
│  CVE-2 (IDOR)                                                               │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │ Saldırgan, ele geçirdiği ID'leri kullanarak herkes adına            │   │
...
│  CVE-3 (Rate Limit)                                                         │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │ Saldırgan, herkes adına SINIRSIZ sayıda talep oluşturur             │   │
│  │ → Veritabanı şişer                                                   │   │
│  │ → Sistem çöker (DoS)                                                 │   │
